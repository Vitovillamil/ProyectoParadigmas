   import greenfoot.*;  // (World, Actor, GreenfootImage, Greenfoot and MouseInfo)
	...
	public class World extends MyWorld
	{
	    ...
	    /*Se crean los constructores con el fin de adicionar los actores en el tablero de juego, darles la posicion dentro de este, logrando insertarlos 
	     * para que hagan parte del de este (Aqui se le da posicion) */	
	        super(700, 600, 1);  
	    ...
	    /**Se realizar in contador con el fin de que nos indique cuantos puntos va ganando el raton al comer un queso  */
	    public Counter getCounter()
	    {
	       return cont;
	    }
	    /**Posicion del contador en el tablero*/
	    public void prepare()
	    {
