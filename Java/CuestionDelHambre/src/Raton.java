...
public class Raton extends Actor
{
    ...
    /**Creamos los movimientos del raton asignandolos por teclado, con las teclas de dezplazamiento, nos basamos en un vertice ya que tenemos ejes de 
     * X y Y */  
   ...
   {  
       int y = getY();
        ...
        /**
         * funcionalidad comer: se implementa el metodo de comer para evaluar cada vez que se mueva el raton  y si encuentra 
